...
/* ───────────────────────────────────────────────
   Gradient Border Magnetic Button
   ─────────────────────────────────────────────── */
function GradientBorderButton({ children, className = "", onClick, ...props }: React.ButtonHTMLAttributes<HTMLButtonElement>) {
  return (
    <div className="relative inline-block rounded-full group/gb">
      <motion.div
        className="absolute -inset-[1.5px] rounded-full opacity-70 group-hover/gb:opacity-100 transition-opacity duration-300"
        style={{
          background:
            "conic-gradient(from 0deg, #0d9488, #10b981, #06b6d4, #0d9488)",
        }}
        animate={{ rotate: 360 }}
        transition={{ duration: 6, repeat: Infinity, ease: "linear" }}
      />
      <div className="absolute -inset-2 rounded-full bg-emerald-500/0 group-hover/gb:bg-emerald-500/20 blur-xl transition-all duration-300 pointer-events-none" />
      <MagneticButton
        onClick={onClick}
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
      ...
      <motion.div
        ...
        transition={{ duration: 18, repeat: Infinity, ease: "easeInOut" }}
      />
      {/* extra orb covering the new lower sections */}
      <motion.div
        className="absolute top-[2000px] left-[15%] w-72 h-72 rounded-full opacity-8 blur-[110px] bg-teal-400"
        animate={prefersReduced ? {} : {
          x: [0, -30, 40, 0],
          y: [0, 50, -30, 0],
        }}
      ...
      />
      <motion.div
        className="absolute top-[2600px] right-[15%] w-80 h-80 rounded-full opacity-8 blur-[120px] bg-cyan-400"
        animate={prefersReduced ? {} : {
          x: [0, 40, -40, 0],
          y: [0, -50, 40, 0],
        }}
    ...
    <style jsx global>{`
      ...
      .shimmer-input::placeholder {
        background: linear-gradient(
          90deg,
          rgba(161, 161, 170, 0.7) 0%,
          rgba(244, 244, 245, 0.95) 50%,
          rgba(161, 161, 170, 0.7) 100%
        );
        background-size: 200% 100%;
        -webkit-background-clip: text;
        background-clip: text;
        color: transparent;
        animation: shimmer-placeholder 3.5s ease-in-out infinite;
      }
      @media (prefers-reduced-motion: reduce) {
        .shimmer-input::placeholder {
          animation: none;
          color: rgb(113, 113, 122);
          -webkit-text-fill-color: rgb(113, 113, 122);
        }
      }
    `}</style>
  );
...
/* ───────────────────────────────────────────────
   NEW: GSAP "How It Works" Steps Section
   Uses ScrollTrigger to pin a connecting line and
   reveal each step as the user scrolls past it.
   ─────────────────────────────────────────────── */
const steps = [
  {
    icon: UserPlus,
    title: "Create your account",
    desc: "Sign up in seconds, no credit card required to get started with Friday.",
  },
  {
    icon: Settings2,
    title: "Tune it to your workflow",
    desc: "Connect your tools and tell Friday how you like to work, it adapts instantly.",
  },
  {
    icon: Rocket,
    title: "Ship faster than ever",
    desc: "Chat, generate, and automate, Friday handles the busywork while you build.",
  },
];
...
function HowItWorksSection() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      // Animated connecting line grows as the section scrolls into view
      if (lineRef.current) {
        gsap.fromTo(
          lineRef.current,
          { scaleY: 0 },
      ...
      // Each step fades + slides in with a slight stagger as it enters
  ...
  return (
    <section
      id="how-it-works"
      ref={sectionRef}
      className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-24 z-10 border-t border-zinc-900"
    >
      <motion.div
        ...
        variants={staggerContainer}
      >
        <motion.h2 className="font-serif text-3xl sm:text-4xl font-bold mb-4 tracking-tight" variants={fadeInUp}>
          How It Works
        </motion.h2>
        <motion.p className="text-zinc-400 text-sm sm:text-base leading-relaxed" variants={fadeInUp}>
          Three steps between you and a faster, smarter workflow.
        </motion.p>
      </motion.div>

      <div className="relative">
        {/* connecting vertical line, animated with GSAP */}
        <div className="absolute left-6 sm:left-8 top-2 bottom-2 w-px bg-zinc-800 hidden sm:block" />
        <div
          ref={lineRef}
          className="absolute left-6 sm:left-8 top-2 bottom-2 w-px bg-gradient-to-b from-teal-400 via-emerald-400 to-cyan-400 hidden sm:block"
          style={{ scaleY: prefersReduced ? 1 : 0 }}
        />
        ...
        <div className="space-y-12 sm:space-y-16">
          {steps.map((step, i) => {
            ...
            return (
              ...
              >
                <div className="relative z-10 shrink-0 h-12 w-12 sm:h-16 sm:w-16 rounded-2xl bg-zinc-900/80 border border-zinc-800 flex items-center justify-center backdrop-blur-sm shadow-lg">
                  <Icon className="h-5 w-5 sm:h-6 sm:w-6 text-emerald-400" />
                  <span className="absolute -top-2 -right-2 h-6 w-6 rounded-full bg-gradient-to-r from-teal-500 to-emerald-500 text-[11px] font-bold text-black flex items-center justify-center shadow-md">
                    {i + 1}
                  </span>
                </div>
                <div className="pt-1 sm:pt-3">
                  <h3 className="text-lg sm:text-xl font-semibold text-white mb-2">{step.title}</h3>
                  <p className="text-zinc-400 text-sm sm:text-base leading-relaxed max-w-md">{step.desc}</p>
                </div>
              </div>
            );
          })}
...
/* ───────────────────────────────────────────────
   NEW: GSAP Testimonials Marquee
   A horizontally auto-scrolling row of quote cards,
   driven by a GSAP infinite tween (pauses on hover).
   ─────────────────────────────────────────────── */
const testimonials = [
  {
    quote: "Friday cut our support response drafting time in half within the first week.",
    name: "Maya R.",
    role: "Head of Support, Lumen",
  },
  {
    quote: "The code generation alone is worth it, it understands our entire repo context.",
    name: "Daniel K.",
    role: "Staff Engineer, Northwind",
  },
  {
    quote: "We replaced three separate tools with Friday's workflow automations.",
    name: "Priya S.",
    role: "Ops Lead, Fernbridge",
  },
  {
    quote: "Fast, accurate, and it actually remembers context across long sessions.",
    name: "Tom A.",
    role: "Product Manager, Vesper",
  },
  {
    quote: "Our team ships documentation twice as fast now. It just gets our tone.",
    name: "Elena V.",
    role: "Technical Writer, Atlas",
  },
];
...
function TestimonialsSection() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // duplicate width since content is rendered twice for a seamless loop
  ...
  return (
    <section className="relative py-20 z-10 border-t border-zinc-900 overflow-hidden">
      <motion.div
      ...
      >
        {/* fade edges */}
        <div className="pointer-events-none absolute inset-y-0 left-0 w-16 sm:w-32 bg-gradient-to-r from-[#030303] to-transparent z-10" />
        <div className="pointer-events-none absolute inset-y-0 right-0 w-16 sm:w-32 bg-gradient-to-l from-[#030303] to-transparent z-10" />

        <div ref={trackRef} className="flex gap-6 w-max px-4">
          {[...testimonials, ...testimonials].map((t, i) => (
            <div
              key={i}
              className="w-72 sm:w-80 shrink-0 rounded-2xl border border-zinc-800 bg-zinc-900/30 backdrop-blur-sm p-6 shadow-lg"
            >
              <Quote className="h-5 w-5 text-emerald-400 mb-4 opacity-70" />
...
/* ───────────────────────────────────────────────
   NEW: Final CTA Section with GSAP text reveal
   ─────────────────────────────────────────────── */
function FinalCTASection() {
  ...
  const headingText = "Start building with Friday today";

  return (
    <section className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-28 z-10 border-t border-zinc-900 text-center">
      <h2
        ref={headingRef}
        className="font-serif text-3xl sm:text-5xl font-bold tracking-tight leading-[1.15] mb-6 flex flex-wrap justify-center gap-x-3"
      >
        {headingText.split(" ").map((w, i) => (
          <span key={i} className="cta-word inline-block">
            {w === "Friday" ? <GradientText>{w}</GradientText> : w}
          </span>
        ))}
      </h2>
      ...
      >
        Join thousands of teams already shipping faster with an AI companion that actually keeps up.
      </motion.p>
      ...
      >
        <GradientBorderButton
          onClick={() => router.push("/register")}
          className="h-12 px-8 rounded-full bg-white text-black font-semibold text-sm sm:text-base transition-all hover:bg-zinc-200 flex items-center gap-2 shadow-md mx-auto"
        >
...
export default function FridayHomepage() {
  ...
  // Refresh ScrollTrigger measurements after mount, since several
  // sections above affect layout height (fonts, images, etc).
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-[#030303] text-zinc-100 font-sans selection:bg-emerald-500/30 overflow-x-hidden relative">
      ...
      <section id="home" className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 md:pt-32 md:pb-36 z-10 text-center" ref={heroRef}>
        ...
        >
          <input
            type="text"
            placeholder="Ask Friday anything..."
            className="shimmer-input flex-1 bg-transparent border-none px-4 text-sm sm:text-base text-white placeholder-zinc-500 focus:outline-none ring-0 focus:ring-0"
            onFocus={() => setInputFocused(true)}
            onBlur={() => setInputFocused(false)}
          />
          <GradientBorderButton
      ...
      {/* ═══════════════════════════════════════════
          NEW: HOW IT WORKS (GSAP ScrollTrigger)
          ═══════════════════════════════════════════ */}
      <HowItWorksSection />

      {/* ═══════════════════════════════════════════
          NEW: TESTIMONIALS (GSAP infinite marquee)
          ═══════════════════════════════════════════ */}
      <TestimonialsSection />

      {/* ═══════════════════════════════════════════
          NEW: FINAL CTA (GSAP word reveal)
          ═══════════════════════════════════════════ */}
      <FinalCTASection />
