  ...
  return (
    <ChatProvider>
      <div className="relative flex h-screen w-full flex-col overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between gap-2 border-b border-zinc-800 px-3 py-2.5 sm:px-4 sm:py-3 md:px-6">
          <h1 className="truncate text-sm font-medium text-zinc-300 sm:text-base">
            {chatTitle}
          </h1>
        ...
        {/* Scrollable message area */}
        <div className="flex-1 overflow-y-auto overflow-x-hidden p-3 pb-28 sm:p-4 sm:pb-32 md:p-6 md:pb-32">
          <MessageList chatId={chatId} />
        </div>

        {/* Fixed input bar - always stays at bottom, doesn't scroll */}
        <div className="absolute bottom-0 left-0 right-0 border-t bg-white/80 backdrop-blur-md p-2 sm:p-3 md:p-4 dark:bg-zinc-950/80">
          <ChatInput chatId={chatId} />
        </div>
      </div>
    </ChatProvider>
