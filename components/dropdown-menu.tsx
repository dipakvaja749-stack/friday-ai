...
>(({ className, sideOffset = 8, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[200px] overflow-hidden rounded-2xl border border-border bg-surface p-1.5 text-foreground shadow-soft animate-fade-in",
        className
      )}
      {...props}
    />
...
>(({ className, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      destructive ? "text-red-400 hover:bg-red-500/10" : "text-foreground/90 hover:bg-white/[0.06]",
